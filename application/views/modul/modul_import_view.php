    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="box box-default">
                <div class="box-header with-border" style="background-color: #ed1e28; color: white;">
					...
					<div class="box-tools pull-right">
						<div class="dropdown pull-right">
							<a href="<?php echo base_url(); ?>public/form/form-soal-ganda.xls" style="color : white;">Form Excel Soal Pilihan Ganda</a>
    					</div>
    				</div>
                </div><!-- /.box-header -->
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-success pull-right" id="import">Import</button>
                </div>
            </div>
        </div>
		</form>
