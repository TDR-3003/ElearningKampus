                    ...
                    <div class="box-header with-border" style="background-color: #ed1e28; color: white;">
                        ...
                        <div class="box-tools pull-right">
                            <div class="dropdown pull-right">
                                <a style="cursor: pointer; color: white;" onclick="refresh_table()">Refresh Data Soal</a>
                            </div>
                        </div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-default">
                                        <div class="box-body" style="max-height: 230px;overflow: auto; background-color: #ed1e28; color: white;">
