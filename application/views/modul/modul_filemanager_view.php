...
<section class="content">
        ...
        <div class="col-xs-6">
            <?php echo form_open_multipart($url.'/upload_file','id="form-upload" class="form-horizontal"'); ?>
                <div class="box box-default">
                    <div class="box-header with-border" style="background-color: #ed1e28; color: white;">
	...
	<div class="row">
        <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border" style="background-color: #ed1e28; color: white;">
    						<div class="box-title">Data File : <a style="cursor:pointer; color : white;" onclick="open_home_dir()">Uploads</a><span id="posisi-file-judul"></span></div>
    						<div class="box-tools pull-right">
    							<div class="dropdown pull-right">
    								<a style="cursor: pointer; color: white;" onclick="refresh_table()">Refresh Data</a>
    							</div>
    						</div>
                    </div><!-- /.box-header -->
