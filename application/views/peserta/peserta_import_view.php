...
<section class="content">
	<div class="row">
        <div class="col-md-12">
            <div class="callout" style="background-color: #ed1e28; color: white;">
                <h4>Informasi</h4>
                    ...
                    <div class="box-header with-border" style="background-color: #ed1e28; color: white;">
    					...
    					<div class="box-tools pull-right">
							<div class="dropdown pull-right">
								<a href="<?php echo base_url(); ?>public/form/form-data-siswa.xls" style="color :white">Download Form Import Siswa</a>
    						</div>
    					</div>
                    </div><!-- /.box-header -->
