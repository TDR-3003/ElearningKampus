    ...
    <section class="content">
        ...
        <div class="row">
            <div class="box box-default box-solid">
                ...
                <div class="box-footer">
                    <button class="btn btn-danger pull-right" id="btn-hentikan">Selesai Tes</button>
                </div>
            </div><!-- /.box -->
        </div>
    </section><!-- /.content -->
    ...
    <?php echo form_open($url.'/hentikan_tes','id="form-hentikan"'); ?>
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" >
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="callout" style="background:#ed1e28; color:white;">
				...
				<div class="box-footer">
					<button type="submit" id="tambah-simpan" class="btn btn-danger">Selesai Tes</button>
